...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
	  var PizzaC=document.getElementsByClassName("randomPizzaContainer");
	  var dx = determineDx(PizzaC[0], size);
	  var newwidth = (PizzaC[0].offsetWidth + dx) + 'px';
    for (var i = 0; i < PizzaC.length; i++) {
      PizzaC[i].style.width = newwidth;
    }
  }
